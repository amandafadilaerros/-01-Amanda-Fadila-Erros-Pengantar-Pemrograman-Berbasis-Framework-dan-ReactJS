    ...
    <div className="min-h-screen px-8 pt-16  bg-white dark:bg-black bg-gradient-to-b from-white to-blue-800 p-8 dark:from-black">
      ...
      <div className="mt-16">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 mt-8">
          <ProjectItem name="Aplikasi 1" url="https://www.linkedin.com/in/amanda-fadila-0116b8266/" urlDisplay="Kantin JTI Polinema" imageSrc={image1} />
          <ProjectItem name="Aplikasi 2" url="https://www.linkedin.com/in/amanda-fadila-0116b8266/" urlDisplay="Portal RW" imageSrc={image2} />
          <ProjectItem name="Aplikasi 3" url="https://www.linkedin.com/in/amanda-fadila-0116b8266/" urlDisplay="Presensia" imageSrc={image3} />
        </ul>
      </div>
    </div>
  );
